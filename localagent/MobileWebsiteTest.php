...
class MobileWebsiteTest extends PHPUnit_Framework_TestCase {
	...
	public function __construct() {
		...
		$browsers = array(
			array(
				...
				'newCommandTimeout' => 0,
				'browserName' => 'Chrome',
				'seleniumServerRequestsTimeout' => '12000',
	...
	public function initiate_browser() {
...
// echo "<pre>group";print_r($value->$iterationval);exit;
...
//$isDisplayed = $el->displayed();
				...
				/*$this->mobileDriver->wait(10,500)->until(
