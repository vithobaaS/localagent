...
// ─── All 300+ Actions ────────────────────────────────────────────────────────
const ALL_ACTIONS = ["AcceptCookies","AssertAttributeValue","AssertContains","AssertDisabled","AssertEnabled","AssertEquals","AssertNotVisible","AssertSelected","AssertVisible","ClearField","Click","ClickAlert","ClickAndHold","CloseTab","CopyText","DoubleClick","DragAndDrop","DragAndDropByOffset","ExecuteScript","ExecuteSQLQuery","GetAttribute","GetCssValue","GetCurrentURL","GetPageTitle","GetText","GoBack","Hover","KeyDown","KeyUp","MaximizeWindow","MinimizeWindow","MockNetworkResponse","Navigate","OpenNewTab","PasteText","PinchToZoom","PressEnter","PressTab","Refresh","Release","RightClick","ScrollDown","ScrollTo","ScrollToCoordinates","ScrollUp","SelectByIndex","SelectByValue","SelectDropdown","SendKeys","Set","SetCheckBoxStatus","SetWindowSize","SwitchDefaultContent","SwitchFrame","SwitchTab","TakeFullPageScreenshot","TouchSwipeLeft","UploadFile","Wait","WaitForTitle","WaitForURL","WaitUntilElementIsClickable","WaitUntilInvisible","WaitUntill","WaitUntillWithtimer","WaitUntilTextPresent","AssertAudioComplete","AssertAudioData","AssertAudioError","AssertAudioIdle","AssertBluetoothComplete","AssertBluetoothData","AssertBluetoothError","AssertCookieComplete","AssertCookieData","AssertCookieError","AssertCryptoComplete","AssertCryptoData","AssertCryptoError","AssertCSVComplete","AssertCSVData","AssertCSVError","AssertDatabaseComplete","AssertDatabaseData","AssertDatabaseError","AssertExcelComplete","AssertExcelData","AssertExcelError","AssertGeoLocationComplete","AssertGeoLocationData","AssertGeoLocationError","AssertIframeComplete","AssertIframeData","AssertIframeError","AssertLayoutComplete","AssertLayoutData","AssertLayoutError","AssertMemoryComplete","AssertMemoryData","AssertMemoryError","AssertMobileComplete","AssertMobileData","AssertMobileError","AssertNetworkComplete","AssertNetworkData","AssertNetworkError","AssertPDFComplete","AssertPDFData","AssertPDFError","AssertPerformanceComplete","AssertPerformanceData","AssertPerformanceError","AssertPixelComplete","AssertPixelData","AssertPixelError","AssertPopupComplete","AssertPopupData","AssertPopupError","AssertSecurityComplete","AssertSecurityData","AssertSecurityError","AssertSessionComplete","AssertSessionData","AssertSessionError","AssertShadowDOMComplete","AssertShadowDOMData","AssertShadowDOMError","AssertSwipeComplete","AssertSwipeData","AssertSwipeError","AssertTouchComplete","AssertTouchData","AssertTouchError","AssertVideoComplete","AssertVideoData","AssertVideoError","AssertVisualComplete","AssertVisualData","AssertVisualError"];
...
const ACTION_CATEGORIES = [
  ...
  { label:'Assertions',  color:'icon-assert',   emoji:'✅', tag:'CHK',  tagStyle:{background:'#fee2e2',color:'#991b1b'}, actions:['AssertEquals','AssertContains','AssertVisible','AssertNotVisible','AssertEnabled','AssertDisabled','AssertSelected','AssertAttributeValue'] },
...
function ActionSidebar({ onAdd }) {
  ...
  const groups = search.trim()
    ? [{ label:'Search Results', color:'icon-default', emoji:'🔍', tag:'', tagStyle:{}, actions: ALL_ACTIONS.filter(a => a.toLowerCase().includes(search.toLowerCase())) }]
    : ACTION_CATEGORIES;
