...
public class DriverService {
    ...
    public boolean startDriver(Integer browserTypeId) {
        ...
        try {
            ...
            // Redirect output logs to local log files to keep background running clean
            pb.redirectOutput(ProcessBuilder.Redirect.to(new File("driver_" + port + "_out.log")));
            pb.redirectError(ProcessBuilder.Redirect.to(new File("driver_" + port + "_err.log")));
