...
public class AssertVisibleAction implements ActionHandler {
    @Override
    public void execute(WebDriver driver, TestStep step, ExecutionService context) throws Exception {
        ...
        if(!driver.findElement(locator).isDisplayed()) { step.result_status = 0; throw new Exception("Element not visible"); }
