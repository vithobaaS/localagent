...
public class AssertEnabledAction implements ActionHandler {
    @Override
    public void execute(WebDriver driver, TestStep step, ExecutionService context) throws Exception {
        ...
        if(!driver.findElement(locator).isEnabled()) { step.result_status = 0; throw new Exception("Element not enabled"); }
